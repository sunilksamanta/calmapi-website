...
const Footer = (props) => (
    <footer id="footer" style={props.timeout ? {display: 'none'} : {}}>
        <div style={{display: 'flex', justifyContent: 'center', marginBottom: '24px'}}>
          ...
          <a href={'https://www.npmjs.com/package/calmapi'} target={'_blank'} style={{borderBottom: 'none', cursor: 'pointer', margin: '0 24px', width: '32px', height: '32px'}}><img style={{width: '100%', filter: 'grayscale(100%)'}} src={npmIcon}/> </a>
        </div>
